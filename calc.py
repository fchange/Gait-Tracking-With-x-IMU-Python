...
def calcAndImage(filePath: str):
    ...
    plt.savefig("calc/" + fileName + "_magFilt.png")
    ...
    # plt.show(block=False)
    plt.savefig("calc/" + fileName + "_velocity.png")
    ...
    # plt.show(block=False)
    plt.savefig("calc/" + fileName + "_position.png")
    ...
    # plt.show(block=False)
    plt.savefig("calc/" + fileName + "_trajectory.png")
...
if __name__ == "__main__":
    ...
    for file in os.listdir(target_dir):
        ...
        # 去除_CalInertialAndMag.csv后缀
        fileName = file.split('_CalInertialAndMag.csv')[0]

        calcAndImage(target_dir + '/' + fileName)
